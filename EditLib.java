...
/**
 * Servlet implementation class EditLib
 */
@WebServlet("/EditLib")
public class EditLib extends HttpServlet {
			...
			HttpSession session = request.getSession(false);
			 ...
			 if(!(test_user.equals(username))){
				...
				if(rs.next()){
					...
					query = "UPDATE librarian SET username = '"+username+"', password = '"+pass+"', phone = '"+phone+"', email = '"+email+"', address = '"+address+"' WHERE id = "+id;
					//System.out.println(query);
					int j = stmt.executeUpdate(query);
					String sub = "Librarian Profile Edition";
					String msg = "Your account has been modified. Your basic update username: "+username+", password = "+pass+"";
					msg = msg + " email: "+email+"";
